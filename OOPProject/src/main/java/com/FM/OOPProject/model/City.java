...
public class City {
	...
	/**
	 * Array contenente i valori dell'indice per la rispettiva città negli anni dal
	 * 1990 al 2018
	 */
	 ...
	 * @param citycode Codice della città europea a cui sono riferiti i dati del
	 *                 record
	 * @param data     Array contenente i valori dell'indice per la rispettiva città
	 *                 negli anni dal 1990 al 2018
	 */
	...
	/**
	 * Metodo che converte il numero dell'anno nel rispettivo indice del vettore
	 * data
	 * 
	 * @param year anno da convertire
	 * @return corrispettivo indice del vettore data
	 * @throws ResponseStatusException Lanciata se l'anno non è nell'intervallo
	 *                                 considerato dai dati
	 */
